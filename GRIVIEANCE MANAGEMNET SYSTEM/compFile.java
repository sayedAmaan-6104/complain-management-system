...
public class compFile {
	...
	private void initList() {
		...
		File f = new File("C:\\Users\\sayed\\Documents\\hii.txt");
		if (f.exists()) {
			ObjectInputStream ois = null;
			try {
				ois = new ObjectInputStream(new FileInputStream("C:\\Users\\sayed\\Documents\\hii.txt"));
				while (true) {
	...
	public void exit() {
		try {
			FileWriter fw = new FileWriter("C:\\Users\\sayed\\Documents\\hii.txt");
			ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream("C:\\Users\\sayed\\Documents\\hii.txt"));
			oos.flush();
			for (complaint comp : compList) {
